...
export const servicesData: ServiceData[] = [
    ...
    // ============================
    {
        ...
        heroImage: '/images/commercial-roof-waterproofing.webp',
        ogImage: '/images/commercial-roof-waterproofing.webp',
        ...
        galleryImages: [
            { src: '/images/commercial-roof-waterproofing.webp', alt: 'Commercial roof waterproofing project in Karachi' },
            { src: '/images/roof-waterproofing-before-after.webp', alt: 'Roof waterproofing before and after comparison' },
            { src: '/images/karachi-roof-coat-2.webp', alt: 'Protective roof coating application' },
            { src: '/images/premium-roof-coating-finish.webp', alt: 'Premium waterproof coating finish on rooftop' },
            { src: '/images/bitumen-membrane-roof-application.webp', alt: 'Bitumen membrane installation on roof surface' },
            { src: '/images/roof-surface-preparation-cleaning.webp', alt: 'Roof surface preparation and cleaning' },
        ],
    },
    ...
    // ============================
    {
        ...
        heroImage: '/images/basement-foundation-waterproofing.webp',
        ogImage: '/images/basement-foundation-waterproofing.webp',
        iconName: 'WaterproofingIcon',
        overview: [
        ...
        galleryImages: [
            { src: '/images/basement-foundation-waterproofing.webp', alt: 'Basement foundation waterproofing treatment' },
            { src: '/images/karachi-basement.webp', alt: 'Professional basement seepage control work' },
            { src: '/images/residential-bungalow-waterproofing.webp', alt: 'Residential bungalow basement treatment' },
            { src: '/images/cementitious-waterproofing-coating.webp', alt: 'Cementitious waterproofing coating application' },
        ],
    },
    ...
    // ============================
    {
        ...
        heroImage: '/images/roof-seepage-control-treatment.webp',
        ogImage: '/images/roof-seepage-control-treatment.webp',
        iconName: 'WaterproofingIcon',
        overview: [
        ...
        galleryImages: [
            { src: '/images/roof-seepage-control-treatment.webp', alt: 'Bathroom seepage control treatment' },
            { src: '/images/residential-bungalow-waterproofing.webp', alt: 'Residential waterproofing solution' },
            { src: '/images/acrylic-waterproofing-chemical-application.webp', alt: 'Waterproofing chemical application' },
            { src: '/images/roof-crack-filling-repair.webp', alt: 'Crack filling and repair work' },
        ],
    },
    ...
    // ============================
    {
        ...
        heroImage: '/images/water-reservoir-tank-lining.webp',
        ogImage: '/images/water-reservoir-tank-lining.webp',
        iconName: 'WaterproofingIcon',
        overview: [
        ...
        galleryImages: [
            { src: '/images/water-reservoir-tank-lining.webp', alt: 'Water reservoir tank lining treatment' },
            { src: '/images/underground-water-tank-leakage-repair.webp', alt: 'Underground water tank leakage repair' },
            { src: '/images/overhead-tank-waterproofing-coating.webp', alt: 'Overhead tank waterproofing coating' },
            { src: '/images/swimming-pool-waterproofing-karachi.webp', alt: 'Swimming pool waterproofing in Karachi' },
        ],
    },
    ...
    // ============================
    {
        ...
        heroImage: '/images/heat-reflective-roof-coating-white.webp',
        ogImage: '/images/heat-reflective-roof-coating-white.webp',
        ...
        galleryImages: [
            { src: '/images/heat-reflective-roof-coating-white.webp', alt: 'Heat reflective white cool roof coating' },
            { src: '/images/industrial-shed-heat-insulation.webp', alt: 'Industrial warehouse heat insulation' },
            { src: '/images/karachi-cool-roof.webp', alt: 'Cool roof coating reducing heat in Karachi' },
            { src: '/images/factory-warehouse-heat-proofing.webp', alt: 'Factory roof heat proofing application' },
            { src: '/images/cool-roof-heat-resistant-paint.webp', alt: 'Cool roof heat-resistant paint application' },
        ],
    },
    ...
    // ============================
    {
        ...
        heroImage: '/images/karachi-chemicals.webp',
        ogImage: '/images/karachi-chemicals.webp',
        ...
        galleryImages: [
            { src: '/images/karachi-chemicals.webp', alt: 'Construction chemicals supply in Karachi' },
            { src: '/images/construction-chemical-drums-supply.webp', alt: 'Chemical drums supply for construction projects' },
            { src: '/images/concrete-admixture-chemical-additive.webp', alt: 'Concrete admixture and chemical additives' },
            { src: '/images/sbr-bonding-agent-latex.webp', alt: 'SBR bonding agent for concrete applications' },
        ],
    },
    ...
    // ============================
    {
        ...
        heroImage: '/images/solid-cement-blocks-construction.webp',
        ogImage: '/images/solid-cement-blocks-construction.webp',
        iconName: 'BlocksIcon',
        overview: [
        ...
        galleryImages: [
            { src: '/images/solid-cement-blocks-construction.webp', alt: 'Solid cement blocks for construction' },
            { src: '/images/concrete-hollow-blocks-stack.webp', alt: 'Stacked concrete hollow blocks' },
        ],
    },
    ...
    // ============================
    {
        ...
        heroImage: '/images/karachi-concrete-2.webp',
        ogImage: '/images/karachi-concrete-2.webp',
        ...
        galleryImages: [
            { src: '/images/karachi-concrete-2.webp', alt: 'Ready-mix concrete supply in Karachi' },
            { src: '/images/concrete-strength-psi-test-certificate.webp', alt: 'Concrete strength PSI test certificate' },
            { src: '/images/expert-construction-site-supervision.webp', alt: 'Expert supervision during concrete pour' },
        ],
    },
    ...
    // ============================
    {
        ...
        heroImage: '/images/karachi-basement.webp',
        ogImage: '/images/karachi-basement.webp',
        ...
        galleryImages: [
            { src: '/images/karachi-basement.webp', alt: 'Dewatering operations for basement construction' },
            { src: '/images/expert-construction-site-supervision.webp', alt: 'Expert supervision during dewatering' },
            { src: '/images/professional-waterproofing-workers-team.webp', alt: 'Professional dewatering team at work' },
        ],
    },
];
