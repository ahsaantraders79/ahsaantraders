...
export const metadata: Metadata = {
    title: 'Terms of Service | Ahsan Traders',
    description: 'Terms and conditions for using Ahsan Traders services.',
};
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto prose prose-slate">
                        ...
                        <p className="text-slate-600 mb-6">
                            Ahsan Traders provides waterproofing, heat proofing, construction chemicals, cemented blocks, ready-mix concrete, and de-watering services across Karachi and Sindh.
                        </p>
                        ...
                        <p className="text-slate-600 mb-6">
                            Ahsan Traders is not liable for damage caused by natural disasters, structural failures, or work by other contractors. Our liability is limited to re-performing the work under warranty terms.
                        </p>
