                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-800 mb-4 sm:mb-5">
                            Ahsaan Traders – Leading Construction Solutions
                        </h2>

                        <p className="text-base sm:text-lg text-slate-600 mb-4 leading-relaxed">
                            Ahsaan Traders is a leading and trusted service provider in the fields of waterproofing, heat proofing, construction chemicals, cemented blocks, strength-gainer admixtures, and ready-mix concrete supplies.
                        </p>
                        ...
                        <p className="text-sm sm:text-base text-slate-600 mb-6 leading-relaxed font-medium">
                            Ahsaan Traders is committed to quality workmanship, timely execution, and customer satisfaction, making us a preferred partner in the construction industry.
                        </p>
