/**
 * Icon Components - SVG icons for the website
 * 
 * PERFORMANCE OPTIMIZATIONS:
 * 1. Server Component - No JS sent to client
 * 2. Inline SVG for best performance and customization
 * 3. Consistent sizing and stroke width
 * 4. Easy color customization via currentColor
 */
...
// Waterproofing Icon
export const WaterproofingIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z" />
    </svg>
);

// Heat Proofing Icon (Sun)
export const HeatProofingIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Construction Chemicals Icon (Flask)
export const ChemicalsIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 3h6M10 9V3M14 9V3M18 21H6a2 2 0 0 1-1.84-2.79L8 12V9h8v3l3.84 6.21A2 2 0 0 1 18 21z" />
    </svg>
);

// Cement Blocks Icon
export const BlocksIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Ready Mix Concrete Icon (Truck)
export const ReadyMixIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Dewatering Icon
export const DewateringIcon = ({ className = '', size = 24 }: IconProps) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2v6M12 22v-6" />
        <path d="M4.93 10.93l1.41 1.41M17.66 11.66l1.41-1.41M2 18h2M20 18h2" />
